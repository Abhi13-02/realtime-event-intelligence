...
# Discovery was split into modules after this benchmark was written; these used
# to all hang off subtheme_discovery.
from app.tasks.discovery.clustering import _step1_cluster
from app.tasks.discovery.models import _ArticleRow, _cosine_similarity
...
CLUSTERING_SETTINGS = SimpleNamespace(
    ...
    subtheme_centroid_match_threshold=0.85,
    subtheme_growing_threshold=0.20,
    subtheme_declining_threshold=0.20,
