...
def run_subtheme_discovery() -> None:
    ...
    try:
        ...
        settings.subtheme_cluster_selection_epsilon = _get_dynamic_setting(cur, "subtheme_cluster_selection_epsilon", settings.subtheme_cluster_selection_epsilon, "Merge clusters closer than this, in UMAP units (~0.5). Pairs with min_samples=1; 0 disables.")
